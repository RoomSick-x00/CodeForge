...
export default function Footer() {
  ...
  return (
    <footer className="bg-cyber-dark border-t border-cyber-red/20 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-6xl mx-auto">
          ...
          <div className="md:col-span-1">
            ...
            <ul className="space-y-2">
              {[
                ...
                { name: 'Rules', id: 'rules' },
                // { name: 'Register', id: 'preregister' }, // commented out
              ].map((link) => (
                <li key={link.name}>
                  <button
                    onClick={() => {
                    ...
                    className="text-cyber-gray/80 hover:text-cyber-red transition-colors duration-200 text-left"
                  >
                    {link.name}
                  </button>
                </li>
        ...
        <div className="border-t border-cyber-red/20 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <button
              onClick={scrollToTop}
              className="flex items-center text-cyber-gray/60 hover:text-cyber-red transition-colors duration-200"
            >
